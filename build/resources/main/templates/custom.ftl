    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-inline">
                <button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-target="#registrar">Registrar nuevo cliente</button>
            </div>
                ...
                <#list clientes as cliente>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/borrar/cliente?id=${cliente.getId()}" class="btn btn-danger btn-xs">Borrar</a>
