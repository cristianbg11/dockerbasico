    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-inline">
                <button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-target="#registrar">Registrar nuevo equipo</button>
            </div>
                ...
                <#list equipos as equipo>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/borrar/equipo?id=${equipo.getId()}" class="btn btn-danger btn-xs">Borrar</a>
                ...
                <form action="/registrar/equipo" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre de equipo" autofocus required/>
                        </div>
