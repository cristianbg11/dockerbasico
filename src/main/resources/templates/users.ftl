    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-inline">
                <button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-target="#registrar">Registrar nuevo usuario</button>
            </div>
                    ...
                    <#list usuarios as usuario>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/borrar/usuario?id=${usuario.getId()}" class="btn btn-danger btn-xs">Borrar</a>
